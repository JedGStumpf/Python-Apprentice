...
# 2.  Write a for loop that prints the numbers 1-10




# 3.  Write a for loop that prints each letter of the string you created in the 1st task
...
# EC_2.a. Create a function that takes a list of letters as an argument and returns a string with all the letters in the list
